...
//         public static double bigFlyWheel = -20;//rps

//         public static final TalonFXConfiguration bigflywheelConfiguration = new TalonFXConfiguration()
//         .withSlot0(new Slot0Configs().withKP(0.1).withKI(0.01).withKD(0)
//         .withKS(0.225).withKV(0.115).withKA(0).withStaticFeedforwardSign(StaticFeedforwardSignValue.UseClosedLoopSign))
//         .withMotionMagic(new MotionMagicConfigs().withMotionMagicAcceleration(100).withMotionMagicCruiseVelocity(400).withMotionMagicJerk(10))
